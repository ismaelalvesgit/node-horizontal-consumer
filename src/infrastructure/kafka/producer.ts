...
import { IKafkaProducer, IKafkaProducerParams } from "@infrastructure/types/IkafkaProducer";
...
export default class KafkaProducer implements IKafkaProducer {
    ...
    async execute<IEntity>({topic, data, headers}: IKafkaProducerParams<IEntity>): Promise<RecordMetadata[]> { 
